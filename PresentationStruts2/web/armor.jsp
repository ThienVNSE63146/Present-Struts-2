...
<html>
    <head>
        <link rel="stylesheet" type="text/css" href="WEB-Content/armor.css">
    ...
    <body onload="visible('<s:property value="%{#request.VISIBLE}"/>')">
        ...
        <div id="header">
            <form action="searchArmor" method="post">
                <table class="logOut">
                    <tr >
        ...
        <div id="main" >
            ...
            <div id="detail">
                            ...
                            <tbody>
                                <tr>
                                    <s:iterator var="dto" value="%{list}" status="counter">
                                        <td onclick="showDetail('<s:property value="%{#dto.image}"/>', '<s:property value="%{#dto.armorName}"/>', '<s:property value="%{#dto.status}"/>', 'abc')" class="img"><s:property value="%{#counter.count}"/></td>
                                        <td><s:property value="%{#dto.armorName}"/></td>
                                        <td><s:property value="%{#dto.status}"/></td>
                                        <td>
                                            <s:url var="deletelink" value="deleteArmor">

                                                <s:param name="name" value="%{#dto.armorName}"/>
                                            </s:url>
                ...
                <div id="detail2">
                    ...
                    <form action="updateArmor" enctype="multipart/form-data" method="post">
                        <div id="loadImage">
                        ...
                        <div id="detailInfo">
                            ...
                            <table>
                                ...
                                <tr  class="detailInfo">
                                    <td>Name</td>
                                    <td ><s:textfield name="ArmorName" id="nameInfo" value="" readonly="true" /></td>
                                </tr>
                                <tr  class="detailInfo">
                                    <td>Role</td>
                                    <td  ><s:textfield name="Status" id="roleInfo" value="" readonly="true"/></td>
                                </tr>
                                <tr  class="detailInfo" >
                                    <td >Mission</td>
            ...
            <form action="insertArmor" enctype="multipart/form-data"  method="post">
                <div id="insert">
                    <div id="insertDetail">
                        <div id="insertFile">
